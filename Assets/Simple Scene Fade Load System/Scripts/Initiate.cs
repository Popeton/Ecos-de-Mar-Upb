...
public static class Initiate
{
    ...
    public static void Fade(string sceneName, Color fadeColor, float fadeDuration)
    {
        ...
        //    AudioManager.instance.gameObject.scene == SceneManager.GetActiveScene())
        //{
         // AudioManager.instance.CleanAll();
        //}
        //    // FmodEvents.instance.CleanUp();
        //    if (VRInteractionHandler.Instance != null)
        //    {
        //        VRInteractionHandler.Instance.ClearAllInteractables();
        //    }
    }
